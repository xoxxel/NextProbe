    ...
    <form
      ...
      <input
        ...
        className={cn(
          ...
          showIcon && iconPosition === "right" ? "pl-4 sm:pl-10 pr-20" : "pl-4 sm:pl-10 pr-4",
          showIcon && iconPosition === "left" ? "pl-20 pr-4 sm:pr-10" : "",
      ...
      {showIcon && (
        <button
          ...
          type="submit"
          className={cn(
            "absolute top-1/2 z-50 -translate-y-1/2 h-8 w-8 rounded-full disabled:bg-gray-100 bg-black dark:bg-zinc-900 dark:disabled:bg-zinc-800 transition duration-200 flex items-center justify-center",
          ...
          {!value && (
            <motion.p
              ...
              className={cn(
                ...
                showIcon && iconPosition === "left" ? "pl-20" : "pl-4 sm:pl-12"
              )}>
